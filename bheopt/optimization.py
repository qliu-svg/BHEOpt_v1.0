...
def optimize_heat_load(locations, H_array, callback_logger, V_T, ANGLE, A, LAMDA, R_w, maxiter, ftol, eps, lim_env, lim_neigh, low_lim, up_lim, initial_q=None, obs_z_range=(20, 70), obs_z_step=20):
    n = len(locations)
    initial_q = np.full(n, 30.0) if initial_q is None else initial_q
