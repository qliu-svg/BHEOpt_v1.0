...
def plot_temperature_heatmap(grid_x, grid_y, sources, H_array, heat_rates, obs_z, V_T, ANGLE, A, LAMDA, integrals, cell_map, x_grid, y_grid, lim_env, lim_neigh, title_suffix=""):
    ...
    fig.add_trace(go.Contour(
        ...
        colorbar=dict(
            ...
            tickvals=np.arange(0, lim_env+0.1, 1),
            len=0.75
        ),
